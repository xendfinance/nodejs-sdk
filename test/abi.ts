export default [
		...
		"outputs": [
			{
				"components": [
					...
					{
						"internalType": "enum EsusuStorage.CurrencyEnum",
						"name": "Currency",
						"type": "uint8"
					},
					{
						"internalType": "enum EsusuStorage.CycleStateEnum",
						"name": "CycleState",
						"type": "uint8"
					},
					{
				...
				"internalType": "struct EsusuStorage.EsusuCycle[]",
				"name": "",
				"type": "tuple[]"
			}
		],
	...
	},
	{
		...
		"name": "UpdateEsusuCycleSharesDuringJoin",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
